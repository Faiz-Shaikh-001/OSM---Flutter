...
const StaffSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'role': PropertySchema(
      ...
      name: r'role',
      type: IsarType.string,
      enumMap: _StaffroleEnumValueMap,
    )
  },
...
Staff _staffDeserialize(
  ...
  object.role = _StaffroleValueEnumMap[reader.readStringOrNull(offsets[2])] ??
      StaffRole.admin;
  return object;
}
...
P _staffDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readString(offset)) as P;
    case 2:
      return (_StaffroleValueEnumMap[reader.readStringOrNull(offset)] ??
          StaffRole.admin) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _StaffroleEnumValueMap = {
  r'admin': r'admin',
  r'manager': r'manager',
  r'cashier': r'cashier',
};
const _StaffroleValueEnumMap = {
  r'admin': StaffRole.admin,
  r'manager': StaffRole.manager,
  r'cashier': StaffRole.cashier,
};
...
extension StaffQueryFilter on QueryBuilder<Staff, Staff, QFilterCondition> {
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailEqualTo(
    String value, {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'email',
        value: '',
  ...
  QueryBuilder<Staff, Staff, QAfterFilterCondition> emailIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'email',
        value: '',
...
extension StaffQuerySortBy on QueryBuilder<Staff, Staff, QSortBy> {
  QueryBuilder<Staff, Staff, QAfterSortBy> sortByEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.asc);
    });
  }

  QueryBuilder<Staff, Staff, QAfterSortBy> sortByEmailDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StaffQuerySortThenBy on QueryBuilder<Staff, Staff, QSortThenBy> {
  QueryBuilder<Staff, Staff, QAfterSortBy> thenByEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.asc);
    });
  }

  QueryBuilder<Staff, Staff, QAfterSortBy> thenByEmailDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.desc);
    });
  }
...
extension StaffQueryWhereDistinct on QueryBuilder<Staff, Staff, QDistinct> {
  QueryBuilder<Staff, Staff, QDistinct> distinctByEmail(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StaffQueryProperty on QueryBuilder<Staff, Staff, QQueryProperty> {
  ...
  QueryBuilder<Staff, String, QQueryOperations> emailProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Staff, StaffRole, QQueryOperations> roleProperty() {
    return QueryBuilder.apply(this, (query) {
