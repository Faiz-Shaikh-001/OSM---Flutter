...
const CustomerModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'customerType': PropertySchema(
      ...
      name: r'customerType',
      type: IsarType.string,
      enumMap: _CustomerModelcustomerTypeEnumValueMap,
    ),
...
int _customerModelEstimateSize(
  ...
  bytesCount += 3 + object.customerType.name.length * 3;
  {
...
void _customerModelSerialize(
  ...
  writer.writeString(offsets[3], object.customerType.name);
...
CustomerModel _customerModelDeserialize(
  ...
  final object = CustomerModel(
    ...
    customerType: _CustomerModelcustomerTypeValueEnumMap[
            reader.readStringOrNull(offsets[3])] ??
        CustomerTypeModel.walkIn,
    dateOfBirth: reader.readDateTimeOrNull(offsets[4]),
...
P _customerModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_CustomerModelcustomerTypeValueEnumMap[
              reader.readStringOrNull(offset)] ??
          CustomerTypeModel.walkIn) as P;
    case 4:
...
const _CustomerModelcustomerTypeEnumValueMap = {
  r'walkIn': r'walkIn',
  r'regular': r'regular',
  r'wholesale': r'wholesale',
  r'corporate': r'corporate',
  r'vip': r'vip',
  r'medical': r'medical',
  r'insurance': r'insurance',
};
const _CustomerModelcustomerTypeValueEnumMap = {
  r'walkIn': CustomerTypeModel.walkIn,
  r'regular': CustomerTypeModel.regular,
  r'wholesale': CustomerTypeModel.wholesale,
  r'corporate': CustomerTypeModel.corporate,
  r'vip': CustomerTypeModel.vip,
  r'medical': CustomerTypeModel.medical,
  r'insurance': CustomerTypeModel.insurance,
};
const _CustomerModelgenderEnumValueMap = {
  r'male': r'male',
  r'female': r'female',
  r'other': r'other',
};
const _CustomerModelgenderValueEnumMap = {
  r'male': GenderModel.male,
  r'female': GenderModel.female,
  r'other': GenderModel.other,
};
...
extension CustomerModelQueryFilter
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterFilterCondition>
      customerTypeBetween(
    CustomerTypeModel lower,
    CustomerTypeModel upper, {
    bool includeLower = true,
    bool includeUpper = true,
    bool caseSensitive = true,
  }) {
...
extension CustomerModelQueryWhereDistinct
  ...
  QueryBuilder<CustomerModel, CustomerModel, QDistinct> distinctByTags() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerModelQueryProperty
  ...
  QueryBuilder<CustomerModel, CustomerTypeModel, QQueryOperations>
  ...
  QueryBuilder<CustomerModel, GenderModel, QQueryOperations> genderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerModel, List<String>, QQueryOperations> tagsProperty() {
    return QueryBuilder.apply(this, (query) {
