      ...
      if (widget.productType == ProductType.frame) {
        ...
        final updatedVariant = originalVariant.copyWith(
          ...
          salesPrice:
              ...
              originalVariant.salesPrice,
          colorName: hexColorController.text.trim().toUpperCase(),
          color: _selectedColor,
          size:
              int.tryParse(sizeController.text.trim()) ?? originalVariant.size,
          localImagesPaths: newImageFile != null
              ? [newImageFile!.path]
              : originalVariant.localImagesPaths,
        );
